Write-Host "Setting back exercise 03-merging"

git switch master
git reset --hard origin/master
git clean -fd

Remove-Item calculator.ts -ErrorAction SilentlyContinue
New-Item -Path . -Name "calculator.ts" -ItemType "File" -Value @"
class Calculator {
...
git commit -am "reseting exercise 03"
