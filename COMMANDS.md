...
git clone https://github.com/ITQ-Reyes/git-practices-ts.git      # Clone this repository to your current working directory
...
git commit -m "Fix changes"             # Make a new commit with a commit message from the command line (recommended)
